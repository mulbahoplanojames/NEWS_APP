...
const API_URL = `https://newsapi.org/v2/everything?q=bitcoin&apiKey=${API_KEY}`;

export const handleBitcoinFetch = (news, setNews) => {
  axios
    .get(API_URL)
    .then((response) => {
      setNews({
        ...
        image: response.data.articles[3].urlToImage,
